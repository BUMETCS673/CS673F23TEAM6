...
import { delPreferRoom, getPreferBookingList } from "/@/service/api/userRoom";
...
const PreferBookingDemo: React.FC = () => {
  ...
  const fetchItems = useCallback(async () => {
    const res = await getPreferBookingList({
      pageNum: page,
      roomNameRule: name,
    });
    if (res?.data?.length) {
...
export default PreferBookingDemo;
